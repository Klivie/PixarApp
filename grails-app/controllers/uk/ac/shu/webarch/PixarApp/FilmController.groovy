...
class FilmController {
    ...
    def save(Film filmInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'filmInstance.label', default: 'Film'), filmInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'filmInstance.label', default: 'Film'), params.id])
                redirect action: "index", method: "GET"
            }
