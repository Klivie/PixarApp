...
<html>
	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<g:link class="primary-button" action="index"><g:message code="default.list.label" args="[entityName]" /></g:link><g:link class="primary-button" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link>
			</div>
			...
			<g:form url="[resource:userInstance, action:'delete']" method="DELETE">
				<fieldset>
					<g:link class="primary-button" action="edit" resource="${userInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
