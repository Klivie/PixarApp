...
class ActorController {
    ...
    def save(Actor actorInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'actorInstance.label', default: 'Actor'), actorInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'actorInstance.label', default: 'Actor'), params.id])
                redirect action: "index", method: "GET"
            }
